...
/// @DnDArgument : "funcName" "scr_enemy_dna_side"
function scr_enemy_dna_side() 
{
	/// @DnDAction : YoYo Games.Common.Execute_Code
	/// @DnDVersion : 1
	/// @DnDHash : 451683E3
	/// @DnDParent : 3A718271
	/// @DnDArgument : "code" "/// @description Execute Code$(13_10)var limit_short_y = 5$(13_10)var limit_long_y = 10$(13_10)enemy_vspd = enemy_vspd + facing_horizontal;$(13_10)if (enemy_vspd >= limit_short_y) or (enemy_vspd <= -limit_short_y)$(13_10){$(13_10)	enemy_vspd = enemy_vspd + (facing_horizontal/2)$(13_10)	if (enemy_vspd >= limit_long_y) or (enemy_vspd <= -limit_long_y)  $(13_10)	{$(13_10)		facing_horizontal *= -1;$(13_10)	}$(13_10)}"
	/// @description Execute Code
	var limit_short_y = 5
	var limit_long_y = 10
	enemy_vspd = enemy_vspd + facing_horizontal;
	if (enemy_vspd >= limit_short_y) or (enemy_vspd <= -limit_short_y)
	{
		enemy_vspd = enemy_vspd + (facing_horizontal/2)
		if (enemy_vspd >= limit_long_y) or (enemy_vspd <= -limit_long_y)  
		{
			facing_horizontal *= -1;
		}
	}
