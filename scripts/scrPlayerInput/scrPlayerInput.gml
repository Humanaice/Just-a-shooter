...
function scrPlayerInput() 
{
	...
	/// @DnDHash : 12A66572
	/// @DnDParent : 12D47443
	/// @DnDArgument : "code" "/// @Get All the players input$(13_10)$(13_10)///Reset Variebles$(13_10)dash = false$(13_10)//playerfire=false$(13_10)//stopplayerfire=false$(13_10)$(13_10)///GamepadInput$(13_10)//script_execute(scrGampadInput)$(13_10)$(13_10)upkey = keyboard_check(ord("W")); //pega o input da tecla "W" - return 1;$(13_10)leftkey = keyboard_check(ord("A"));//pega o input da tecla  "A" - return 1;$(13_10)downkey = keyboard_check(ord("S"));//pega o input da tecla  "S" - return 1;$(13_10)rightkey = keyboard_check(ord("D"));//pega o input da tecla  "D" - return 1;$(13_10)dashkey = keyboard_check_pressed(ord("J"));$(13_10)//firekey =  keyboard_check(ord("H"));$(13_10)//stopfirekey = !keyboard_check(ord("H"))$(13_10)$(13_10)$(13_10)if (dashkey) $(13_10){$(13_10)	dash = true$(13_10)}$(13_10)/*$(13_10)if (firekey) $(13_10){$(13_10)	playerfire = true$(13_10)}$(13_10)$(13_10)if (stopfirekey)$(13_10){$(13_10)	stopplayerfire = true$(13_10)}$(13_10)*/"
